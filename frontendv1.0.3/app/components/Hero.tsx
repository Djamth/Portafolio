      ...
      <div className="section-shell relative z-10 flex min-h-[100svh] flex-col pt-24">
        <div className="relative flex flex-1 flex-col">
          <div className="relative z-20 pt-[8vh] text-center">
            <p className="mb-5 font-mono text-[12px] uppercase tracking-[.38em] text-white/35">Software · Systems · Engineering</p>
            <h1 className="v103-hero-name whitespace-nowrap text-[clamp(4rem,12vw,12rem)] font-black leading-[.76] tracking-[-.075em] [word-spacing:9.8rem] text-white">DENIS JAMIL</h1>
          </div>

          <div className="pointer-events-none absolute inset-x-0 bottom-[-10%] top-[15%] z-30 flex items-end justify-center">
          ...
          <div className="relative z-40 mt-auto flex items-end justify-between gap-6 pb-10">
            ...
            <a href="#projects" className="pointer-events-auto hidden items-center gap-3 font-mono text-[12px] uppercase tracking-[.2em] text-white/45 transition hover:text-white sm:flex">Explorar proyectos <span aria-hidden="true">↓</span></a>
          </div>
        </div>
      </div>
