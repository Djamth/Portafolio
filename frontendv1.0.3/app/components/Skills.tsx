      ...
      <div className="section-shell relative">
        ...
        <div className="mt-12 grid grid-cols-3 gap-4 sm:grid-cols-4 md:grid-cols-6">
          {skills.map(([name, icon], index) => (
            <ScrollReveal key={name} delay={(index % 6) * 55}>
            <div className="group rounded-[22px] border border-white/90 bg-white/75 p-4 text-center shadow-[0_12px_32px_rgba(53,76,120,.06)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:border-[#bdc9f2] hover:shadow-[0_18px_34px_rgba(53,76,120,.12)] motion-reduce:transform-none">
