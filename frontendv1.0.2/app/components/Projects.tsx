      ...
      <div className="section-shell relative">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          {visibleProjects.map((project) => (
            <article key={project.slug} className="group overflow-hidden rounded-[26px] border border-white/90 bg-white/75 shadow-[0_18px_45px_rgba(53,76,120,.08)] backdrop-blur-xl transition duration-300 hover:border-[#b8c7f1] hover:shadow-[0_24px_55px_rgba(53,76,120,.14)]">
